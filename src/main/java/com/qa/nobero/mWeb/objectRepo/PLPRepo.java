...
public class PLPRepo {
	...
	@FindBy(xpath="//section[@id='shopify-section-template--16047755788454__heading']//h1")
	private WebElement PLPTitle;
	public WebElement getPLPTitle() {
		return PLPTitle;
	}
	@FindBy(xpath="//section[@id='shopify-section-template--16047755788454__heading']//h3")
	...
	public String GetColorNameAndselectColor(int index) {	
		List<WebElement> list = this.getEachColor();
		int count = 0;
		String colorName = "";
		for (WebElement webElement : list) {
	...
	@FindBy(xpath="//form[@id='submit-mobile-form']//li[@class='flex pt-[18px] pl-1  ']//span")
	...
	public String GetSizeNameAndselectSize(int index) {
		List<WebElement> list = this.getAllSize();
		int count = 0;
		String sizeName = "";
		for (WebElement webElement : list) {
