...
public class HamburgerRepo {
	...
	@FindBy(xpath="//div[@id='shopify-section-template--16056169726118__24a22b73-39f3-4d67-80bb-744aa7a9aa87']//button[text()='Shop All Products']")
	...
	@FindBy(xpath="//div[@id='shopify-section-template--16056169726118__22b80a91-3775-40f2-8617-cc151a81ea02']//button[text()='Shop All Products']")
