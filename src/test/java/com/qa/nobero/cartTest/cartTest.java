...
public class cartTest extends BaseClass {
	...
	@Test(retryAnalyzer = com.qa.nobero.genericutility.RetryAnalyzer.class, enabled = false,priority = 1)
	...
	@Test(retryAnalyzer = com.qa.nobero.genericutility.RetryAnalyzer.class, enabled = false,priority = 2)
...
//					}
	...
	public void ToVerifyProductSalesCountisEnabledInCartpage() throws InterruptedException {  
		//Create Object for Singleton Class 
				RepositoryHub repo=new RepositoryHub(driver);
	...
	@Test(retryAnalyzer = com.qa.nobero.genericutility.RetryAnalyzer.class, enabled = true)
	public void ToVerifyTotalCartSummary() throws InterruptedException {  
				//Create Object for Singleton Class 
				RepositoryHub repo=new RepositoryHub(driver);
				...
				wUtil.scrollToElement(driver, repo.getPDPRepo().getrecentlyViewdProduct().get(0));
				Thread.sleep(4000);
				repo.getPDPRepo().getrecentlyViewdProduct().get(0).click();
			    ...
			    wUtil.scrollToElement(driver, repo.getCartRepo().geViewProduct());
	...
	@Test
	public void ToVerifyThatProductIsIncrementedinCartPage() throws InterruptedException {
		//Create Object for Singleton Class 
		RepositoryHub repo=new RepositoryHub(driver);
	...
	@Test
	public void ToVerifyThatProductIsDecrementeInCartPage() throws InterruptedException {
		//Create Object for Singleton Class 
		RepositoryHub repo=new RepositoryHub(driver);
	...
	@Test
	public void ToVerifyThatProductRemoveFeatureIsEnabledInCartPage() throws InterruptedException {
