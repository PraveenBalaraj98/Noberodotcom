...
public class SearchRepo {
	...
	public WebElement getLessthan₹500search() {
		return lessthan₹500search;
	}

	public WebElement get₹501to₹1000() {
		return ₹501to₹1000;
	}

	public WebElement get₹1001to₹1500() {
		return ₹1001to₹1500;
	}



	public WebElement get₹1501to₹2000() {
		return ₹1501to₹2000;
	}
	

	public WebElement getMorethan₹2000search() {
		return morethan₹2000search;
	}
	...
	@FindBy(xpath="//div[@id='form-body-main']")
